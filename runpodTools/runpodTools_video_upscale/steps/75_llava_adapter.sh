...
# adapterStart.sh
#
# Generated by runpodTools/steps/75_llava_adapter.sh::generateScript.
# Starts the LLaVA adapter service in tmux (or foreground fallback),
# validates port availability, and appends logs under /workspace/logs.
