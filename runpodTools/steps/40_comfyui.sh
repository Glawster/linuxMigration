...
# comfyStart.sh
#
# Generated by runpodTools/steps/40_comfyui.sh::generateScript.
# Starts ComfyUI in tmux (or foreground fallback), validates prerequisites,
# checks port availability, and writes logs to /workspace/logs.
