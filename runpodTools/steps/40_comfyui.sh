...
main() {
  ...
  condaEnvRun "$ENV_NAME" python -m pip install --upgrade pip wheel
  condaEnvRun "$ENV_NAME" pip install torch torchvision torchaudio --index-url "$torch_index"
  ...
  condaEnvRun "$ENV_NAME" pip install "${req_args[@]}"
