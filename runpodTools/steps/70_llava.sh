...
# llavaStart.sh
#
# Generated by runpodTools/steps/70_llava.sh::generateScript.
# Starts LLaVA controller, worker, and web services in tmux sessions,
# validates required paths/commands, and writes logs under /workspace/logs.
